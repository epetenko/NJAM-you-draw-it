...
c.svg.append('circle').attr('cx',c.totalWidth-winwidth).attr('cy',c.height*.08).attr('r', 5).attr('class', 'intro-dot')

c.svg.append('text').attr('x',c.totalWidth-winwidth+5).attr('y',c.height*.05).text('Start dragging here').attr('class','intro-text')
